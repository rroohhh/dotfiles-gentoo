...
(let* ((get-color (lambda (graphic-color terminal-color)
  ...
  (custom-theme-set-faces
   ...
   `(link                ((t (:foreground ,bright_blue  :underline t))))
   `(link-visited        ((t (:foreground ,bright_purple  :underline t))))
   `(match               ((t (:background ,bright_orange :foreground ,dark0))))
   `(menu                ((t (:background ,dark2 :foreground ,light1))))
   `(minibuffer-prompt   ((t (:foreground ,bright_aqua ))))
   `(mode-line           ((t (:background ,dark1 :foreground ,light1))))
   `(mode-line-buffer-id ((t (:foreground ,bright_blue ))))
   ...
   `(success             ((t (:foreground ,bright_green ))))
   ...
   `(warning             ((t (:foreground ,bright_orange ))))
   ...
   `(font-lock-function-name-face        ((t (:foreground ,bright_green ))))
   `(font-lock-keyword-face              ((t (:foreground ,bright_red))))
   `(font-lock-negation-char-face        ((t (:foreground ,bright_yellow ))))
   ...
   `(font-lock-warning-face              ((t (:foreground ,bright_red ))))
   ...
   `(rainbow-delimiters-unmatched-face
    ...
    ;; popup
    `(popup-face                                ((t (:foreground ,light1 :background ,dark1))))
    `(popup-menu-mouse-face                     ((t (:foreground ,light0 :background ,faded_green))))
    `(popup-menu-selection-face                 ((t (:foreground ,light0 :background ,faded_green))))
    `(popup-tip-face                            ((t (:foreground ,light2 :background ,dark2))))
   ...
   `(compilation-mode-line-exit       ((t (:foreground ,bright_green ))))
   `(compilation-mode-line-fail       ((t (:foreground ,bright_red ))))
   `(compilation-mode-line-run        ((t (:foreground ,bright_orange ))))
   ...
   ;; `(helm-source-header    ((t (:background ,dark0 :foreground ,bright_yellow  :underline nil :height 1.3))))
   ...
   `(completions-first-difference ((t (:foreground ,bright_yellow ))))

   ;; grep
   `(grep-context-face ((t (:foreground ,light1))))
   `(grep-error-face   ((t (:foreground ,bright_red  :underline t))))
   `(grep-hit-face     ((t (:foreground ,bright_blue))))
   `(grep-match-face   ((t (:foreground ,bright_orange ))))
   ...
   ;; ido-mode
   `(ido-first-match ((t (:foreground ,bright_yellow ))))
   `(ido-only-match  ((t (:foreground ,bright_orange ))))
   `(ido-subdir      ((t (:foreground ,neutral_blue ))))
   ...
   `(message-header-cc         ((t (:foreground ,bright_blue ))))
   `(message-header-newsgroups ((t (:foreground ,bright_yellow ))))
   `(message-header-other      ((t (:foreground ,bright_aqua ))))
   `(message-header-subject    ((t (:foreground ,bright_orange ))))
   `(message-header-to         ((t (:foreground ,bright_green ))))
   `(message-header-xheader    ((t (:foreground ,bright_purple ))))
   `(message-mml               ((t (:foreground ,bright_yellow ))))
   ...
   `(gnus-server-agent   ((t (:foreground ,bright_aqua ))))
   `(gnus-server-closed  ((t (:foreground ,bright_blue :slant italic))))
   `(gnus-server-denied  ((t (:foreground ,bright_red ))))
   `(gnus-server-offline ((t (:foreground ,bright_yellow ))))
   `(gnus-server-opened  ((t (:foreground ,bright_green ))))

   `(gnus-summary-cancelled           ((t (:foreground ,bright_red ))))
   `(gnus-summary-high-ancient        ((t (:foreground ,bright_blue ))))
   `(gnus-summary-high-read           ((t (:foreground ,bright_green ))))
   `(gnus-summary-high-ticked         ((t (:foreground ,bright_orange ))))
   `(gnus-summary-high-undownloaded   ((t (:foreground ,light3 ))))
   `(gnus-summary-high-unread         ((t (:foreground ,light1 ))))
   ...
   `(gnus-summary-selected            ((t (:foreground ,bright_yellow ))))
   ...
   `(gnus-group-news-1         ((t (:foreground ,bright_red ))))
   `(gnus-group-news-1-empty   ((t (:foreground ,neutral_red))))
   `(gnus-group-news-2         ((t (:foreground ,bright_orange ))))
   `(gnus-group-news-2-empty   ((t (:foreground ,neutral_orange))))
   `(gnus-group-news-3         ((t (:foreground ,bright_yellow ))))
   `(gnus-group-news-3-empty   ((t (:foreground ,neutral_yellow))))
   `(gnus-group-news-4         ((t (:foreground ,bright_green ))))
   `(gnus-group-news-4-empty   ((t (:foreground ,neutral_green))))
   `(gnus-group-news-5         ((t (:foreground ,bright_blue ))))
   `(gnus-group-news-5-empty   ((t (:foreground ,neutral_blue))))
   `(gnus-group-news-6         ((t (:foreground ,bright_purple ))))
   ...
   `(custom-group-tag               ((t (:foreground ,bright_yellow  :height 1.2 :inherit variable-pitch))))
   `(custom-group-tag-1             ((t (:foreground ,bright_purple :inherit custom-group-tag))))
   `(custom-group-subtitle          ((t (:foreground ,bright_yellow  :height 1.05 :inherit variable-pitch))))
   `(custom-variable-tag            ((t (:foreground ,bright_aqua  :inherit variable-pitch))))
   ...
   `(ediff-fine-diff-A           ((t (:background ,bright_red :foreground ,dark0 ))))
   `(ediff-fine-diff-Ancestor    ((t (:background ,bright_red :foreground ,dark0 ))))
   `(ediff-fine-diff-B           ((t (:background ,bright_green :foreground ,dark0 ))))
   `(ediff-fine-diff-C           ((t (:background ,bright_aqua :foreground ,dark0 ))))
   ...
   `(diff-refine-added   ((t (:background ,bright_green :foreground ,dark0 ))))
   `(diff-refine-changed ((t (:background ,bright_aqua :foreground ,dark0 ))))
   `(diff-refine-removed ((t (:background ,bright_red :foreground ,dark0 ))))
   ...
   `(anzu-mode-line  ((t (:foreground ,bright_purple ))))
   ...
   `(font-latex-sectioning-5-face         ((t (:foreground ,bright_yellow  :inherit variable-pitch))))
   ...
   `(markdown-header-face-1         ((t (:foreground ,bright_red ))))
   `(markdown-header-face-2         ((t (:foreground ,bright_green ))))
   `(markdown-header-face-3         ((t (:foreground ,bright_orange ))))
   `(markdown-header-face-4         ((t (:foreground ,bright_blue ))))
   `(markdown-header-face-5         ((t (:foreground ,bright_yellow ))))
   `(markdown-header-face-6         ((t (:foreground ,bright_purple ))))
   ...
   `(comint-highlight-prompt ((t (:foreground ,bright_aqua ))))

   ;; SLIME
   '(slime-repl-input-face            ((t ())))
   ...
   `(slime-repl-prompt-face           ((t (:foreground ,bright_aqua ))))
   ...
   `(avy-lead-face            ((t (:background ,bright_red :foreground ,dark0 ))))
   `(avy-lead-face-0          ((t (:background ,bright_yellow :foreground ,dark0 ))))
   `(avy-lead-face-1          ((t (:background ,bright_aqua :foreground ,dark0 ))))
   `(avy-lead-face-2          ((t (:background ,bright_purple :foreground ,dark0 ))))
   ...
   ;; undo-tree-mode
   `(undo-tree-visualizer-active-branch-face ((t (:foreground ,light1 ))))
   ...
   ;; dired{,+}
   `(dired-directory  ((t (:foreground ,neutral_blue ))))
   `(dired-flagged    ((t (:foreground ,bright_red  :underline t))))
   `(dired-header     ((t (:background ,dark1 :foreground ,bright_yellow))))
   '(dired-ignored    ((t (:inherit shadow))))
   `(dired-mark       ((t (:foreground ,bright_green ))))
   `(dired-marked     ((t (:foreground ,bright_purple ))))
   ...
   `(diredp-compressed-file-name   ((t (:foreground ,neutral_red ))))
   '(diredp-compressed-file-suffix ((t (:inherit diredp-compressed-file-name))))
   `(diredp-date-time              ((t (:foreground ,bright_yellow))))
   `(diredp-deletion               ((t (:foreground ,bright_red  :underline t))))
   `(diredp-deletion-file-name     ((t (:foreground ,bright_red  :underline t))))
   `(diredp-dir-heading            ((t (:background ,dark1 :foreground ,bright_yellow))))
   `(diredp-dir-name               ((t (:foreground ,neutral_blue ))))
   ...
   `(diredp-mode-line-flagged      ((t (:foreground ,bright_red ))))
   `(diredp-mode-line-marked       ((t (:foreground ,bright_purple ))))
   ...
   ;; eshell
   `(eshell-ls-archive          ((t (:foreground ,neutral_red ))))
   `(eshell-ls-backup           ((t (:foreground ,neutral_gray))))
   `(eshell-ls-clutter          ((t (:foreground ,dark3))))
   `(eshell-ls-directory        ((t (:foreground ,neutral_blue ))))
   `(eshell-ls-executable       ((t (:foreground ,neutral_green ))))
   `(eshell-ls-missing          ((t (:foreground ,neutral_orange ))))
   `(eshell-ls-product          ((t (:foreground ,light4))))
   `(eshell-ls-readonly         ((t (:foreground ,neutral_purple ))))
   `(eshell-ls-special          ((t (:background ,dark0_s :foreground ,bright_purple ))))
   `(eshell-ls-symlink          ((t (:foreground ,neutral_aqua ))))
   `(eshell-ls-unreadable       ((t (:foreground ,neutral_yellow))))
   `(eshell-prompt              ((t (:foreground ,bright_aqua ))))
   ...
   ;; which-func-mode
   `(which-func ((t (:foreground ,bright_green ))))

   ;; info
   `(info-menu-star ((t (:foreground ,bright_red))))
   `(info-node      ((t (:foreground ,bright_orange  :slant italic))))
   `(info-title-4   ((t (:foreground ,bright_yellow  :inherit variable-pitch))))

   ;; outline-mode
   `(outline-1 ((t (:foreground ,bright_red ))))
   `(outline-2 ((t (:foreground ,bright_green ))))
   `(outline-3 ((t (:foreground ,bright_orange ))))
   `(outline-4 ((t (:foreground ,bright_blue ))))
   `(outline-5 ((t (:foreground ,bright_yellow ))))
   `(outline-6 ((t (:foreground ,bright_purple ))))
   `(outline-7 ((t (:foreground ,bright_aqua ))))
   `(outline-8 ((t (:foreground ,neutral_orange ))))

   ;; ivy
   `(ivy-current-match           ((t (:background ,neutral_orange :foreground ,dark0 ))))
   `(ivy-minibuffer-match-face-1 ((t (:background ,bright_orange :foreground ,dark0 ))))
   `(ivy-minibuffer-match-face-2 ((t (:background ,bright_purple :foreground ,dark0 ))))
   `(ivy-minibuffer-match-face-3 ((t (:background ,bright_aqua :foreground ,dark0 ))))
   `(ivy-minibuffer-match-face-4 ((t (:background ,bright_blue :foreground ,dark0 ))))
   ...
   `(haskell-interactive-face-prompt ((t (:foreground ,bright_aqua ))))
   ...
   `(elfeed-search-unread-count-face ((t (:foreground ,light1 ))))
   `(elfeed-search-unread-title-face ((t (:foreground ,light1 ))))
   ...
   `(erc-keyword-face           ((t (:foreground ,bright_yellow ))))
   '(erc-my-nick-face           ((t (:inherit erc-current-nick-face))))
   '(erc-my-nick-prefix-face    ((t (:inherit erc-nick-prefix-face))))
   `(erc-nick-default-face      ((t (:foreground ,bright_blue ))))
   `(erc-nick-msg-face          ((t (:foreground ,bright_orange ))))
   '(erc-nick-prefix-face       ((t ( :inherit erc-default-face))))
   `(erc-notice-face            ((t (:foreground ,bright_purple))))
   `(erc-pal-face               ((t (:foreground ,bright_green))))
   `(erc-prompt-face            ((t (:foreground ,bright_aqua ))))
