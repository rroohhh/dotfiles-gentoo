...
(let* ((get-color (lambda (graphic-color terminal-color)
                    ...
                    (if (display-graphic-p) graphic-color graphic-color)))
  ...
  (custom-theme-set-faces
   ...
   `(region              ((t (:background ,dark2)))) ;;selection
   ...
   `(helm-source-header    ((t (:background ,dark0 :foreground ,bright_yellow :weight bold :underline nil :height 1.3))))
